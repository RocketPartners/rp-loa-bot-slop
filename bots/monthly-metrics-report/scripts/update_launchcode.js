#!/usr/bin/env node
/**
 * Update Monthly Metrics Report on LaunchCode
 *
 * Usage:
...
const job = await api.jobs.update('670bf250-48a3-4fac-acce-270dd6609b17', updateConfig);

console.log('Job updated!');
console.log('  ID:', job.id);
console.log('  Slug:', job.slug);
console.log('');
console.log('To trigger: api.jobs.run("670bf250-48a3-4fac-acce-270dd6609b17")');
`);

#!/usr/bin/env node
/**
 * Update Yearly Metrics Report on LaunchCode
 *
 * Usage:
...
// NOTE: Replace the job ID below after first deploy
console.log(`
const updateConfig = ${configJson};

const job = await api.jobs.update('7dbc09b9-ca09-4a8a-92c3-cb62777ee792', updateConfig);

console.log('Job updated!');
console.log('  ID:', job.id);
console.log('  Slug:', job.slug);
console.log('');
console.log('To trigger: api.jobs.run("7dbc09b9-ca09-4a8a-92c3-cb62777ee792")');
`);
